...
if !goal_achieved {
	if (game_score > 30) && !goal{
		global.tags.casual = scr_display_tag(global.tags.casual, "Casual", room_width/4, 96);
		global.tags.pixelart = scr_display_tag(global.tags.retro, "Pixel Art", room_width*2/4, 96);
		global.tags.easy = scr_display_tag(global.tags.easy, "Easy", room_width*3/4, 96);
		goal_achieved = 1;
		goal = 1;
	}
}
